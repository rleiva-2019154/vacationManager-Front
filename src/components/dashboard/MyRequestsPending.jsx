...
export const MyRequestsPending = () => {
    const { pendingRequests, isLoading, error } = useGetPendingRequests();

    return (
        <div className="p-4">
            <h3 className="text-xl font-bold mb-4 text-center">Solicitudes Pendientes</h3>
            ...
            {pendingRequests && pendingRequests.length > 0 ? (
                    ...
                    {pendingRequests.map((request) => (
                        <Card 
                            ...
                            sx={{ 
                                ...
                                '&:hover': {
                                    transform: 'translateY(-5px)',  // Animación al hacer hover
                                }
                            }}
                            className="bg-white"
                        >
                ...
                !isLoading && <p className="text-center">No hay solicitudes pendientes</p>
            )}
        </div>
    );
};
