...
import { useGetApprovedBossRequests } from "../../hooks/useGetApprovedBossRequests";

export const ApprovedRequests = () => {
    const { approvedRequests, loading, error } = useGetApprovedBossRequests();

    return (
        <div className="p-4">
            <h3 className="text-xl font-bold mb-4 text-center">Solicitudes de Vacaciones Aprobadas (Boss)</h3>
