...
import { useGetEmployeeRequests } from "../../hooks/useGetEmployeeRequests";

export const SeeAllRequestsEmployees = () => {
    const { requests, loading, error } = useGetEmployeeRequests();

    return (
        <div className="p-4">  {/* Ajusta el padding general del componente */}
            <h3 className="text-xl font-bold mb-4 text-center">Solicitudes de Vacaciones de los empleados</h3> {/* Menor margen entre el título y contenido */}
