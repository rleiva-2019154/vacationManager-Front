import { useGetRejectedRequestsEmployees } from "../../hooks/useGetRejectedRequestsEmployees"; // Importa el hook correspondiente
...
export const RejectedRequestsForEmployee = () => {
    const { rejectedRequests, loading, error } = useGetRejectedRequestsEmployees();
