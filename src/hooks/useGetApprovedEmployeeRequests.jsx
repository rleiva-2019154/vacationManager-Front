...
import { getApprovedEmployeeRequestsAPI } from "../services/api"; // Asegúrate de que este API esté correctamente implementada

export const useGetApprovedEmployeeRequests = () => {
    ...
    useEffect(() => {
        const fetchApprovedRequests = async () => {
            try {
                const response = await getApprovedEmployeeRequestsAPI();
                if (response.error) {
